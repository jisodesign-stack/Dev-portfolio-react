          ...
          <div className="row">
            ...
            <div className="col-lg-6 mb-4 mb-lg-0">
              <div className="card contact-card p-4">
                <h2 className="h4 fw-bold mb-4 border-bottom pb-2">Formulaire de contact</h2>
            ...
            <div className="col-lg-6">
              <div className="card contact-card p-4 h-100">
                <h2 className="h4 fw-bold mb-4 border-bottom pb-2">Mes coordonnées</h2>
                <div className="mb-4">
                  ...
                  <p className="mb-3">
                    ...
                    <a href="mailto:john.doe@gmail.com" className="contact-link">john.doe@gmail.com</a>
                  </p>
                </div>
